   ...
   try{
       ...
       if(email) {
           ...
           if(user){
              ...
              return res.status(200).send(`${MYOTP} this is your otp`)
           }else{
...
app.post("/verify", async  (req,res)=>{
    ...
    try{
        ...
        if(+TimeNow_10DIGIT > decoded.exp  ){ // if it expired
            ...
            return res.status(200).send("This is Valid TOKEN")
        }
...
mongoose.connect("mongodb://localhost:27017/nem201S2").then((res)=>{
    app.listen(8080, ()=>{
