...
export const getProducts = ({perPage,page,sortBy}) => {
  return fetch(`https://dbioz2ek0e.execute-api.ap-south-1.amazonaws.com/mockapi/get-products?page=${page}&limit=${perPage}&orderBy=${sortBy}`)
  .then((res)=> res.json())
};
